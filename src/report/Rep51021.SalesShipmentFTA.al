...
report 51021 "Sales - Shipment FTA"
{
    // +----------------------------------------------------------------------------------------------------------------+
    // | ProdWare                                                                                                       |
    // | www.prodware.fr                                                                                                |
    ...
    // 
    // //>>MODIF HL
    // TI304847.001 ALM:Do 14/12/2015  : - Correction ending block display
    //                                     Delete right marging (old value 0,5)
    // +----------------------------------------------------------------------------------------------------------------+
    // 
    // 
    // //>>FTA.REPORT2018-0511
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './SalesShipmentFTA.rdlc';

    Caption = 'Sales - Shipment FTA';
    ...
    dataset
    {
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
                    ...
                    dataitem("Sales Shipment Line"; "Sales Shipment Line")
                    {
                        ...
                        begin
                            ...
                            if "Sales Shipment Line".Type <> "Sales Shipment Line".Type::Item then
                                SalesLineDescription := "Sales Shipment Line".Description[100];
                            //<<FTA.REPORTS2018-0607
                            ...
                            if (Type = Type::Item) and ("No." <> '') then begin
                                ...
                                if RecLItemCrossReference.FINDSET() then
                                    TexGRefFou := STRSUBSTNO(CstG002, RecLItemCrossReference."Reference Type") + ' - ';
                                TexGRefFou += RecGItem."No. 2";


                                //>>FTA.REPORTS2018-0607
                                //item description
                                SalesLineDescription := RecGItem.Description[100];
            ...
            begin
                ...
                FormatAddr.SalesShptBillTo(CompanyAddr, ShipToAddr, "Sales Shipment Header"); //todo comâny adress 
    ...
    begin
        ...
        if RecGUserReport.GET(USERID, 51021) then begin
