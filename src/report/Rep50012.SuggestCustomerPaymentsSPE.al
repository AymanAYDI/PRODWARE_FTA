...
report 50012 "Suggest Customer Payments SPE" //Duplicated from 10864
{
            ...
            repeat
                ...
                repeat
                    ...
                    if SummarizePer in [SummarizePer::Customer, SummarizePer::"Due date"] then begin
                        ...
                        CustLedgEntry."Applies-to ID" := CodGNextDocNo;
    ...
    // <<< Procedures SPE Migration >> 23
    procedure GetCustLedgEntries2(Positive: Boolean; Future: Boolean)
    begin
        CustLedgEntry.Reset();
        // CustLedgEntry.SetCurrentKey("Customer No.", Open, Positive, "Due Date");
        CustLedgEntry.SetCurrentKey("Customer No.", Open, Positive, "Customer Posting Group", "Due Date");
        CustLedgEntry.SetRange("Customer No.", Customer."No.");
        CustLedgEntry.SetRange(Open, true);
        CustLedgEntry.SetRange(Positive, Positive);
        CustLedgEntry.SetRange("Currency Code", CurrencyFilter);
            ...
            repeat
                ...
                repeat
                    ...
                    if SummarizePer in [SummarizePer::Customer, SummarizePer::"Due date"] then begin
                        ...
                        CustLedgEntry."Applies-to ID" := CodGNextDocNo;//TempPaymentPostBuffer."Applies-to ID";
                        CODEUNIT.Run(CODEUNIT::"Cust. Entry-Edit", CustLedgEntry)
                    end else begin
                        GenPayLine3.Reset();
                        GenPayLine3.SetCurrentKey(
