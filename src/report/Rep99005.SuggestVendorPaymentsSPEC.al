report 99005 "Suggest Vendor PaymentsSPEC"//393

{
    ...
    dataset
    {
        dataitem(Vendor; Vendor)
        {
            ...
            column(BooGCheckPostGroup; BooGCheckPostGroup)
            {
            }
            ...
            begin
                ...
                SelectedDim.SetRange("Object ID", REPORT::"Suggest Vendor PaymentsSPEC");
                ...
                group(Options)
                {
                    ...
                    group("Summarize Results")
                    {
                        ...
                        field(SummarizePerDimText; SummarizePerDimText)
                        {
                            ...
                            begin
                                DimSelectionBuf.SetDimSelectionMultiple(3, REPORT::"Suggest Vendor PaymentsSPEC", SummarizePerDimText);
                            end;
                        }
                    }
    ...
    // migration des procedures 

    local procedure GetVendLedgEntries2(Positive: Boolean; Future: Boolean)
    var
        IsHandled: Boolean;
    begin
        VendLedgEntry.Reset();
    ...
    local procedure MakeGenJnlLines2()
    var
        GenJnlLine1: Record "Gen. Journal Line";
        DimBuf: Record "Dimension Buffer";
